...
export const personalInfo = {
  ...
  description:
    "Seven years in HR technology at ASTRNT — a principal contributor to the Laravel + React recruiter platform and candidate assessment apps, then the engineer who led their ground-up Next.js / TypeScript rebuild and wrote the product specifications that drove it.",
  location: "Indonesia",
...
export const skills: Skill[] = [
  ...
  { name: "Azure Blob Storage", category: "Cloud & DevOps", level: 80 },
...
export const projects: Project[] = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    highlights: [
      "Principal contributor across the full product lifecycle, 2019 → present",
...
export const experiences: Experience[] = [
  {
    ...
    current: true,
    description:
      "Leading the modernisation of the company's flagship product while specifying the work that drives it. Owning the ASTRNT 2.0 dashboard rebuild on a modern stack — and the product specification layer behind it.",
    achievements: [
