...
export const personalInfo = {
  ...
  headline:
    "I build hiring software end to end, then modernise it before it slows your business down.",
  description:
    "Product-minded senior full-stack engineer. For seven years at ASTRNT I wrote the spec, built the product, and kept it running: from a Laravel and React recruiter platform to a Next.js and TypeScript rebuild with AI scoring and matching. Now open to senior full-stack and product-engineering roles.",
  location: "Indonesia",
...
export const heroProof: { value: string; label: string }[] = [
  { value: "7 yrs", label: "HR tech, one company" },
  { value: "18", label: "Feature areas shipped in 6 months" },
  { value: "2,500", label: "Concurrent users kept stable" },
  { value: "11,697", label: "Commits across 35 repos" },
];
...
export const cloudMigration: CloudMigrationChapter = {
  ...
  bullets: [
    ...
    "The activity-log store was re-homed from AWS DynamoDB onto MongoDB, which the platform already ran, because Azure has no managed DynamoDB equivalent.",
  ],
};
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    kind: "work",
    description:
      "Ground-up rebuild of the recruiter dashboard on Next.js 16, React 19 and TypeScript, replacing the seven-year-old Laravel/React platform.",
    longDescription:
    ...
    highlights: [
      ...
      "Dual-database live-migration architecture with no cutover outage",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Twin build-aws / build-azure pipelines per app, so environment hosts switch at build time",
...
export const experiences: Experience[] = [
  {
    ...
    endDate: "Aug 2026",
    description:
      "Led the modernisation of the company's flagship product while specifying the work that drove it: the ASTRNT 2.0 dashboard rebuild on a modern stack, plus the product specification layer behind it.",
    achievements: [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Productised one shared codebase into three white-labelled products: Kognisi, Popskul and CDC career portals",
      "Opened the job-market data-acquisition capability, a seven-site scraping suite plus a Python/Flask service",
      "Helped carry the platform from AWS to Azure, including Azure DevOps hosting, per-environment build-aws / build-azure pipelines, PM2 process management, and the activity-log store re-homed from DynamoDB onto MongoDB",
    ],
    techUsed: [
      "Laravel",
      "PHP",
  ...
  },
  {
    ...
    current: true,
    description:
      "Designed and built a monitoring platform from the ground up, from concept and architecture to backend, frontend and deployment, for Shopee merchants.",
    achievements: [
